        ...
        return (
            <Segment>
                ...
                <Form  style={{'marginTop':'15px'}}>
                    ...
                    <Form.Field required control={Input} label='User Name' placeholder='User Name' style={styleForm} />


                    <Form.Field required control={Input} label='Password' placeholder='Password' style={styleForm} />
                    <Form.Field required control={Input} label='Confirm Password' placeholder='Confirm Password' style={styleForm} />
