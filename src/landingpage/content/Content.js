...
const Content = () => {
    return ( <
        ...
        size = "large"
        style = {
            { 'fontSize': '4em' } } > < Icon name = "audible" / > Udemy < /Header> <
        Header as = "h2"
        textAlign = "center"
        color = "grey"
        style = {
            { 'marginBottom': '2em' } } > Trung tam Tieng Anh cua anh Tien < /Header> <
        Grid >
        <
        ...
        as = { Link }
        to = '/homepage' > GET STARTED < Icon name = "arrow right" / > < /Button> <
        /Grid.Column> <
        /Grid> <
        /Container>
    );
